          ...
          {isModalOpen && (
             <Modal 
                ...
                title={
                    ...
                    modalType === 'bulkDues' ? "Update Iuran Massal" : 
                    modalType === 'announcement' ? "Buat Pengumuman" :
                    modalType === 'poll' ? "Buat Voting Baru" :
                    modalType === 'editHouse' ? "Edit Data Warga" : "Kelola Data"
                }
             >
                 {modalType === 'official' && (

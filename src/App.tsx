...
import { 
  ...
  Database, Lock, Eye, EyeOff, Save, Trash, Sparkles, Loader2, CheckSquare, Bell, Vote, BarChart2, PieChart, LocateFixed, Navigation, ShoppingCart, Repeat, Wand2
} from 'lucide-react';
...
const AdminDashboard = ({ 
  ...
  // NEW: HANDLE BULK PIN GENERATION
